...
<head>
    ...
    <style>
        ...
        .blockHeader {
            background-image: url(image/img_bg/bg_dl_image.jpg);
...
<body>
    <div class="blockHeader">
        ...
        <p><a href="home.html">Trang chủ</a><i class="fa-solid fa-circle-chevron-right"></i><a href="tracuu.html">Tra cứu</a><i class="fa-solid fa-circle-chevron-right"></i><a href="homePage.php">Tra cứu dược liệu</a></p>
    </div>
    </div>
    ...
    <div class="blockMain">
        <div class="blockAllMedicine">
            ...
            $id = $_GET['sid'];
            $lietke_sql="SELECT * FROM duoclieu WHERE id=$id";
            $result = mysqli_query($conn, $lietke_sql);
            $r = mysqli_fetch_assoc($result)
            ?>
                <div class="blockMedicine">
                <h3><?php echo $r['tenduoclieu'];?></h3>
                <img src="image/img_chinh_sua/img_duoc_lieu/<?php echo $r['anhduoclieu'];?>" alt="">
                <h4>Tên tiếng việt</h4>
                <h5><?php echo $r['tentiengviet'];?></h5>
                <h4>Tên khoa học</h4>
                <p><?php echo $r['tenkhoahoc'];?></p>
                <h4>Họ</h4>
                <p><?php echo $r['ho'];?></p>
                <h4>Mô tả</h4>
                <p><?php echo $r['mota'];?></p>
                <h4>Phân bố</h4>
                <p><?php echo $r['phanbo'];?></p>
                <h4>Bộ phận dùng</h4>
                <p><?php echo $r['bophandung'];?></p>
                <h4>Công dụng</h4>
                <p><?php echo $r['congdung'];?></p>
                </div>
        </div>
