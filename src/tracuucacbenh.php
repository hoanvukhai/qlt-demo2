...
<head>
    ...
    .blockHeader{
    background-image:url(image/img_bg/bg_img_menu_benh.jpg);
...
<body>
    <div class="blockHeader">
        ...
        <div class="blockSearch">
            <form method="post">
                <input type="text" name="noidung" placeholder="Tìm kiếm bệnh...">
                <div>
        ...
        <div class="blockSearchAllMedicine">
            <?php
                ...
                if (isset($_POST['btn'])) {
                    ...
                    $sql = "SELECT * FROM benh WHERE tenbenh LIKE '%$noidung%'";
                    ...
                    <div class="headerSearch">
                        ...
                        <button class="btnTwo" type="button" onclick="window.location.href = 'tracuucacbenh.php'">
                            <i class="fa-solid fa-tent-arrow-turn-left"></i>
                        </button>
                        </div>    
                    </div>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        ?>
                            ...
                            <a style="text-decoration: none; color: green;" href="tracuubenh.php?sid=<?php echo $row['id'];?>">
                                <img style="width: 100px; height: 100px" style src="image/img_chinh_sua/img_benh/<?php echo $row['anhbenh'];?>" alt="">
                                <p style="width: 100px; font-size: 10px"><?php echo $row['tenbenh'];?></p>
                            </a>
                            </div>
                        <?php
                        }
    ...
    <div class="menuCon">
        ...
        <p><a href="home.html">Trang chủ</a><i class="fa-solid fa-circle-chevron-right"></i><a href="tracuu.html">Tra cứu</a><i class="fa-solid fa-circle-chevron-right"></i><a href="tracuucacbenh.php">Tra cứu theo bệnh</a></p>
    </div>
    <div class="blockMain">
        <div class="blockAllMedicine">
            <?php
            require_once 'ketnoi.php';
            $lietke_sql="SELECT * FROM benh order by anhbenh, tenbenh";
            $result = mysqli_query($conn, $lietke_sql);
            while ($r = mysqli_fetch_assoc($result)){
            ?>
                <div class="blockMedicine">
                <a style="text-decoration: none; color: green;" href="tracuubenh.php?sid=<?php echo $r['id'];?>">
                <img style="width: 200px; height: 200px" src="image/img_chinh_sua/img_benh/<?php echo $r['anhbenh'];?>" alt="">
                <p style="width: 200px"><?php echo $r['tenbenh'];?></p>
                </a>
                </div>
            <?php
            }
